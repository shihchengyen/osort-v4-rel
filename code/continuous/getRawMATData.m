...
% Remove all data points larger than 3 s.d. from mean
ind_exceed3sd = abs(dataSamplesFull) > 3*std(dataSamplesFull);
dataSamplesFull = dataSamplesFull(~ind_exceed3sd);
timestampsFull = timestampsFull(~ind_exceed3sd);
