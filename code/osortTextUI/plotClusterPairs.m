...
switch(plotMode)
    case 1
        ...
        errorbar( 1:N, m1, s1, 'color', col1 );
        hold on
        errorbar( 1:N, m2, s2, 'color', col2 );
        hold off
    ...
    case 2
        ...
        plot( edges, n1, 'color', col1, 'linewidth', 2);
        hold on
        plot( edges, n2, 'color', col2, 'linewidth', 2);
        hold off
    ...
    case 3
        ...
        if sum(isnan(bc1))==0 & sum(isnan(bc2))==0
            h1=bar(bc1, fhat1,  'Facecolor', col1, 'BarWidth', 1 );
            h2=bar(bc2, fhat2,  'Facecolor', col2 , 'BarWidth', 1);
            hold off
